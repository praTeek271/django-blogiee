...
from django_admin_honeypot.forms import HoneypotLoginForm
from django_admin_honeypot.models import LoginAttempt
...
class AdminHoneypot(generic.FormView):
    template_name = 'django_admin_honeypot/login.html'
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        login_url = reverse('django_admin_honeypot:login')
    ...
    def get_context_data(self, **kwargs):
        ...
        context.update({
            **AdminSite().each_context(self.request),
            ...
            REDIRECT_FIELD_NAME: reverse('django_admin_honeypot:index'),
            'title': _('Log in'),
        })
        return context
